...
<!--Sign Up Page-->
     ...
     <style>
       ...
       *{margin:0; padding:0;}   
           ...
           input{width: 100%; background: none; border: 1px solid #fff; border-radius: 3px; padding: 6px 15px; box-sizing: border-box; margin-bottom: 30px; font-size: 16px; color: #fff;}
